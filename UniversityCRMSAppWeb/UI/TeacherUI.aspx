...
<body>
    ...
    <div>
     <table>
                ...
                <tr>
                    <td><asp:Label ID="Label5" runat="server" Text="Designation"></asp:Label></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><asp:DropDownList ID="departmentrDropDownList" runat="server" ></asp:DropDownList></td>

                </tr>
         <tr>
                    <td><asp:Label ID="Label7" runat="server" Text="course to be taken"></asp:Label></td>
                    <<td><asp:TextBox ID="courseToBeTakenTextBox" runat="server"></asp:TextBox></td>
